import { prisma, Prisma, UserEntityCreateInput, UserEntityPromise, UserEntityUpdateInput, UserEntityWhereUniqueInput, UserEntityNullablePromise } from '../../prisma/index';
import { UserEntity } from '../../typeorm/entities/user.entity';
import { EmailFormtError, IdIsNullError, PhoneFormtError, UserIsNullError, UserMustDataNullError } from '../errors/error';
...
export class UserServiceImpl {
     ...
     */
    insert(user: UserEntityCreateInput): UserEntityPromise {
    ...
    delete(user: UserEntityWhereUniqueInput): UserEntityPromise {
        return this.prisma.deleteUserEntity(user);
    }
    ...
    get(where: UserEntityWhereUniqueInput): UserEntityNullablePromise {
        return this.prisma.userEntity(where);
    }

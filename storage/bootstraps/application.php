...
$application->singleton(Illuminate\Contracts\Http\Kernel::class, Application\Http\Kernel::class);
$application->singleton(Illuminate\Contracts\Console\Kernel::class, Application\Console\Kernel::class);
